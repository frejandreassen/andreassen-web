    ...
    onSubmit: async (values, {resetForm}) => {
      axios.post('/api/contact', 
        ...
        .then( function(response) {
          setMessageConfirmation("Thank you for getting in touch!")
    ...
    <div>
      ...
      <section className="py-26 bg-white dark:bg-gray-900">
        <div className="container md:px-4 mx-auto">
          ...
          <div className="flex flex-wrap mx-4 mb-16 items-center">
            <div className="w-full lg:w-1/2 md:px-4 mb-16 lg:mb-0">
              <div className="flex flex-wrap mx-4">
                <div className="w-full sm:w-1/2 md:px-4 mb-12">
                ...
                <div className="w-full sm:w-1/2 md:px-4 mb-12 sm:mb-0">
                  <div className="inline-flex mb-8 w-20 h-20 items-center justify-center bg-white text-indigo-900 border-3 border-indigo-900 rounded-full shadow-md">
