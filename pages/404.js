        ...
        <div className="container px-4 mx-auto relative">
          <div className="max-w-xl mx-auto text-center">
            ...
            <div className="flex flex-wrap items-center justify-center">
              <Link href="/">
                <a className="inline-block w-full md:w-auto py-4 px-6 mb-4 md:mb-0 md:mr-6 text-center leading-6 text-lg text-white font-extrabold bg-indigo-800 hover:bg-indigo-900 border-3 border-indigo-900 shadow rounded transition duration-200">
                  Go back to Homepage
                </a>
              </Link>
              <Link href="">
                <a className="inline-block w-full md:w-auto py-4 px-6 text-center leading-6 text-lg text-indigo-900 hover:text-white font-extrabold bg-white hover:bg-indigo-800 border-3 border-indigo-900 shadow rounded transition duration-200">
                  Try Again
                </a>
              </Link>
            </div>
