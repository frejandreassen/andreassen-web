...
import { ExternalLinkIcon, DownloadIcon, PuzzleIcon, CogIcon, OfficeBuildingIcon, AcademicCapIcon } from '@heroicons/react/outline'
          ...
          <div className="container px-4 mx-auto">
            <div className="flex flex-wrap -mx-4 mb-12 items-center">
              ...
              <div className="w-full lg:w-1/2 px-4">
                ...
                <p className="text-xl font-bold text-gray-400 mb-2">Last updated <Moment locale="sv" format="MMMM YYYY">{cv.settings.lastUpdated}</Moment></p>
            ...
            <div className="flex flex-wrap -mx-4">
              <div className="w-full lg:w-2/5 px-4 mb-12 lg:mb-0">
                <ul className="mb-12">
                  ...
                  <li><a className="inline-block text-xl hover:text-indigo-800 font-extrabold" href="#">Summary</a></li>
                </ul>
                <div className="md:flex pt-8 items-center border-t-3 border-indigo-900">
                    <a onClick={copyCurrentURL} className="inline-block w-full md:w-auto mb-4 md:mb-0 md:mr-6 py-3 px-8 text-center leading-6 text-lg text-white font-extrabold bg-indigo-800 hover:bg-indigo-900 border-3 border-indigo-900 shadow rounded transition duration-200" href="javascript:void(0);">
                      Copy Link
                    </a>
                  <a className="inline-flex items-center justify-center w-14 h-14 mr-6 border-3 border-indigo-900 hover:border-indigo-800 rounded bg-white text-indigo-900 hover:text-indigo-800 shadow" href="#">
                  ...
                  <a className="inline-flex items-center justify-center w-14 h-14 border-3 border-indigo-900 hover:border-indigo-800 rounded bg-white text-indigo-900 hover:text-indigo-800 shadow" href="#">
              ...
              <div className="w-full lg:w-3/5 px-4">
                ...
                <p className="text-xl font-extrabold leading-7 mb-10">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec ullamcorper mattis lorem non. Ultrices praesent amet ipsum justo massa. Eu dolor aliquet risus gravida nunc at feugiat consequat purus. Non massa enim vitae duis mattis. Vel in ultricies vel fringilla.</p>
                <div className="mb-10 p-8 border-l-3 border-indigo-500">
                  <p className="text-2xl font-extrabold leading-8 mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec ullamcorper mattis lorem non. Ultrices praesent amet ipsum justo massa. Eu dolor aliquet risus gravida nunc at feugiat consequat purus.</p>
                  <span className="text-xl text-gray-400 font-extrabold leading-7">— John Doe, CEO &amp; Founder</span>
                </div>
                <p className="text-xl font-extrabold leading-7 mb-12">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec ullamcorper mattis lorem non. Ultrices praesent amet ipsum justo massa. Eu dolor aliquet risus gravida nunc at feugiat consequat purus. Non massa enim vitae duis mattis. Vel in ultricies vel fringilla.</p>
                <img className="block mb-6 w-full h-112 object-cover border-3 border-indigo-900 rounded-2xl shadow-lg" src="https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d?ixlib=rb-1.2.1&amp;ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;auto=format&amp;fit=crop&amp;w=2072&amp;q=80" alt=""/>
                <p className="text-xl font-extrabold text-gray-400 mb-8">Non massa enim vitae duis mattis. Vel in ultricies vel fringilla.</p>
                <h3 className="text-2xl font-extrabold mb-4">Header 1</h3>
                <p className="text-xl font-extrabold leading-7 mb-10">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec ullamcorper mattis lorem non. Ultrices praesent amet ipsum justo massa. Eu dolor aliquet risus gravida nunc at feugiat consequat purus. Non massa enim vitae duis mattis. Vel in ultricies vel fringilla.</p>
                <p className="text-xl font-extrabold leading-7 mb-10">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec ullamcorper mattis lorem non. Ultrices praesent amet ipsum justo massa. Eu dolor aliquet risus gravida nunc at feugiat consequat purus. Non massa enim vitae duis mattis. Vel in ultricies vel fringilla.</p>
                <p className="text-xl font-extrabold leading-7 mb-10">Sagittis et eu at elementum, quis in. Proin praesent volutpat egestas sociis sit lorem nunc nunc sit. Eget diam curabitur mi ac. Auctor rutrum lacus malesuada massa ornare et. Vulputate consectetur ac ultrices at diam dui eget fringilla tincidunt. Arcu sit dignissim massa erat cursus vulputate gravida id. Sed quis auctor vulputate hac elementum gravida cursus dis.</p>
                <ul className="mb-10">
                  <li className="text-xl font-extrabold leading-7 mb-2">1. Lectus id duis vitae porttitor enim gravida morbi.</li>
                  <li className="text-xl font-extrabold leading-7 mb-2">2. Eu turpis posuere semper feugiat volutpat elit, ultrices suspendisse. Auctor vel in vitae placerat.</li>
                  <li className="text-xl font-extrabold leading-7">3. Suspendisse maecenas ac donec scelerisque diam sed est duis purus.</li>
                </ul>
                <p className="text-xl font-extrabold leading-7">Vestibulum placerat magna nulla, sit amet venenatis sapien consequat ut. Cras pulvinar, lorem tristique pharetra finibus, dui erat finibus orci, a vehicula arcu sapien id metus. Quisque quis lorem a sem porttitor feugiat. Etiam quis congue est. Donec fermentum ac libero a pretium. Nulla nisl sem, euismod ut eros vitae, egestas scelerisque enim. Vivamus id pharetra massa. Nulla aliquet erat elit, a gravida dui efficitur vel. Sed pulvinar diam sed neque ullamcorper semper. Nulla elementum arcu lacus, quis porta nisl posuere varius. Quisque tempus libero sed urna posuere hendrerit.</p>
              </div>
            </div>
          </div>
        </section>
