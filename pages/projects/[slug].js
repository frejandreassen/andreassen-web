          ...
          <div className="container md:px-4 mx-auto">
            <div className="max-w-4xl mx-auto mb-12 text-center">
              ...
              {project.categories.map((category,i) => (
                <span key={i} className="inline-flex mb-6 mr-3 h-6 items-center justify-center text-xs font-extrabold px-2 text-indigo-900 rounded border-2 border-indigo-900 bg-green-200 uppercase shadow-sm">{category}</span>
              ))}
            </div>
            <img className="block w-full mb-12 h-112 lg:h-140 object-cover border-3 border-indigo-900 rounded-2xl shadow-lg" src={project.coverImageUrl} alt={project.coverImageAltText}/>
